...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/motivation/motivation_1_bfe91589.png}
    \caption{Motivation for Online Generic Event Boundary Detection. Contrasts offline GEBD (using full video context) with online GEBD (streaming, causal processing inspired by Event Segmentation Theory from cognitive science).}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/algorithm/algorithm_1_4fe904a3.png}
    \caption{High-level architecture of ESTimator++ showing the Hierarchical Memory-augmented Transformer (HMT), Structured Multi-view Prediction Error (SMPE), Adaptive Multi-scale Temporal Discriminator (AMTD), and the Structural Consistency Loss (SCL) framework for online generic event boundary detection.}
    \label{fig:algorithm}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/main_result/online_kinetics_f1_lineplot.png}
    \caption{Online Generic Event Boundary Detection performance on Kinetics-GEBD: F1 score comparison across relative distance thresholds.}
    \label{fig:main_result_kinetics}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/main_result/online_tapos_f1_heatmap.png}
    \caption{Online Generic Event Boundary Detection performance on TAPOS: F1 score heatmap comparison.}
    \label{fig:main_result_tapos}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/main_result/offline_kinetics_avgf1_barchart.png}
    \caption{Comparison of average F1 scores on Kinetics-GEBD between online and offline methods.}
    \label{fig:offline_kinetics}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/main_result/inference_efficiency_barchart.png}
    \caption{Inference efficiency comparison: processing time per frame for different methods.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ablation/ablation_components_line_plot.png}
    \caption{Ablation study showing the contribution of each proposed component (HMT, SMPE, SCL, AMTD) to the overall performance.}
    \label{fig:ablation_components}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ablation/ablation_smpe_bar_chart.png}
    \caption{Ablation study on the Structured Multi-view Prediction Error components showing the contribution of Feature Reconstruction Error, Predictive Smoothness Error, and Memory Perturbation Error.}
    \label{fig:ablation_smpe}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ablation/ablation_amtd_scatter_plot.png}
    \caption{Ablation study on the Adaptive Multi-scale Temporal Discriminator (AMTD) showing its contribution to boundary detection performance.}
    \label{fig:ablation_amtd}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ablation/ablation_scl_box_plot.png}
    \caption{Ablation study on the Structural Consistency Loss (SCL) components showing the contribution of focal reconstruction loss, smoothness loss, and clustering loss.}
    \label{fig:ablation_scl}
\end{figure}
